...
public class BindRequestsTest {
    ...
    @Order(1)
    @Test
    void testCreateBindRequest_nonexistentSpecialist_404() throws Exception {
    ...
    @Order(2)
    @Test
    void testCreateBindRequests_validSpecialistName_2xx() {
    ...
    @Order(3)
    @Test
    void testCreateBindRequests_duplicateRequest_409() throws Exception {
    ...
    @Order(4)
    @Test
    void testGetPendingAndApprovedBinds_200() throws Exception {
    ...
    @Order(5)
    @Test
    void testApprovePendingBind_nonexistentClient_404() throws Exception {
    ...
    @Order(6)
    @Test
    void testApprovePendingBind_validClient_204() {
    ...
    @Order(7)
    @Test
    void testGetAllBinds_200() throws Exception {
    ...
    @Order(8)
    @Test
    void testDiscardPendingBind_nonexistentClient_404() throws Exception {
    ...
    @Order(9)
    @Test
    void testDiscardPendingBind_validClient_204() {
    ...
    @Order(10)
    @Test
    void testBindsState_200() throws Exception {
        ResponseEntity<String> entity = getPendingBinds(specialistA);
        log.info(entity.toString());
    ...
    private ResponseEntity<String> requestBind(String client, String specialist) {
        ...
        return restTemplate.postForEntity(
                CLIENT_REQUEST_BIND_PATH + "/" + specialist,
                null,
                String.class
        );
    }
    ...
    private ResponseEntity<String> approveBindRequest(String specialist, String client) {
        ...
        return restTemplate.postForEntity(
                SPECIALIST_APPROVE_BIND_PATH + "/" + client,
                null,
                String.class
        );
    }
    ...
    private ResponseEntity<String> discardBindRequest(String specialist, String client) {
        setHeaders(specialist);
        return restTemplate.postForEntity(
                SPECIALIST_DISCARD_BIND_PATH + "/" + client,
                null,
                String.class
        );
    }
    ...
    private ResponseEntity<String> getPendingBinds(String specialist) {
        ...
        return restTemplate.getForEntity(
                SPECIALIST_GET_PENDING_BINDS_PATH,
                String.class
        );
    }
    ...
    private ResponseEntity<String> getApprovedBinds(String specialist) {
        setHeaders(specialist);
        return restTemplate.getForEntity(
                SPECIALIST_GET_APPROVED_BINDS_PATH,
                String.class
        );
    }
