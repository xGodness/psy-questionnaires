package ru.xgodness.questionnaire;
...
import ru.xgodness.questionnaire.model.*;
...
public class QuestionnaireProvider {
    ...
    private static final String QUESTIONNAIRES_DIR_PATH = PropertiesProvider.getRESOURCES_PATH() + "questionnaires/";
    @Getter
